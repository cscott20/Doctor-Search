...
start_read = 1000 #exclusive start #enter previous run_limit
run_limit = 1800 #inclusive stop Stop after recording this many doctors
...
read_file = "cigna_nyu_brook.csv"
write_file = "NYU_Brook.csv"
