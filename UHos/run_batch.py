...
start_read = 500 #exclusive start #enter previous run_limit
run_limit = 1000 #inclusive stop Stop after recording this many doctors
...
read_file = "cigna_primary_care.csv"
write_file = "uhos_primary_care.csv"
...
dt = f2.readlines()
for entry in dt:
    tim.append(float(entry.strip()) * multiplier)
f2.close()
